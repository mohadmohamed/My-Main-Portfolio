...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl z-50 rounded-2xl bg-[#0A0A0F]/60 backdrop-blur-xl border border-white/5">
        <nav className="relative mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold text-white">Mohad Mohamed</span>
          </Link>
